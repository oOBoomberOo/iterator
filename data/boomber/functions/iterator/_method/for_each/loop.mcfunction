...
# NOTE: Maybe simplify this to reduce scoreboard checking?

execute if score #bb.iter.is_some bb.iter.var = #bb.iter.bool.true bb.iter.enum run function boomber:iterator/for_each/call
